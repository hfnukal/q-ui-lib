    ...
    <div class="space-y-10">
      <div>
        ...
        <p class="mt-2 max-w-prose text-callout text-secondary-label">
          Kruhový indikátor (Tailwind <code class="text-caption-1 text-label">animate-spin</code>) z{" "}
          <code class="rounded-md bg-fill-secondary px-1.5 py-0.5 text-caption-1 text-label">
            components/spinner
          </code>
          — výchozí barva segmentu <code class="text-caption-1 text-label">accent</code>.
        </p>
      </div>
      ...
      <section class="space-y-3">
        ...
        <p class="text-callout text-secondary-label">
          Prop <code class="text-caption-1 text-label">label</code> přidá <code class="text-caption-1 text-label">role=&quot;status&quot;</code> a skrytý text (<code class="text-caption-1 text-label">sr-only</code>).
        </p>
      ...
      <section class="space-y-3">
        ...
        <p class="text-callout text-secondary-label">
          Přepiš např. <code class="text-caption-1 text-label">border-t-system-green</code> přes <code class="text-caption-1 text-label">class</code>.
        </p>
        <CodeExample code={codeCustom}>
          <div class="rounded-lg border border-separator-opaque/40 bg-surface-raised p-6">
            <Spinner class="border-t-system-green" size="lg" />
          </div>
        </CodeExample>
