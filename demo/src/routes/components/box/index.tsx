  ...
  return (
    <div class="space-y-10">
      ...
      <section class="space-y-3">
        ...
        <CodeExample>
          <Desc>
            Tokenové předvolby: <code class="text-caption-1">padding</code>,{" "}
            <code class="text-caption-1">background</code>, okraj a zaoblení.
          </Desc>
          <TabExample>
            <Box
              padding="md"
              ...
              border
              rounded="lg"
              class="text-body text-label"
            >
              <code class="text-caption-1">padding=&quot;md&quot;</code>, raised
              surface, border.
            </Box>
          </TabExample>
          <TabCode>{codePresets}</TabCode>
        </CodeExample>
      </section>
      ...
      <section class="space-y-3">
        ...
        <CodeExample>
          <Desc>
            Vlastní layout a vzhled jednou třídou přes{" "}
