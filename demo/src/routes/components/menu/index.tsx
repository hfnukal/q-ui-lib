    ...
    <div class="space-y-10">
      ...
      <section class="space-y-3">
        ...
        <CodeExample>
          ...
          <TabCode>{`import { Menu } from "~/components/ui/menu";
    ...
    <Menu.Item>Smazat</Menu.Item>
      ...
      <section class="space-y-3">
        ...
        <CodeExample>
          ...
          <TabCode>{`import { LuCopy, LuSave, LuTrash } from "@qwikest/icons/lucide";
import { Menu } from "~/components/ui/menu";
import { MenuItem } from "~/components/ui/menu-item";
import { KbdShortcut } from "~/components/ui/kbd-shortcut";
  ...
  <Menu.Popover>
    ...
    <Menu.Item>
      ...
      <section class="space-y-3">
        ...
        <CodeExample>
          <Desc>Zaškrtnutí se zobrazí jako fajfka vlevo. Stav řídí <code class="text-caption-1">bind:checked</code>.</Desc>
          <TabExample>
            <_Example1 />
          </TabExample>
  ...
  return (
    <Menu.Root>
      ...
      <section class="space-y-3">
        ...
        <CodeExample>
          <Desc>Vybraná položka se označí tečkou. Stav řídí <code class="text-caption-1">bind:value</code> na <code class="text-caption-1">RadioGroup</code>.</Desc>
          <TabExample>
            <_Example2 />
          </TabExample>
          <TabCode>{`import { useSignal } from "@builder.io/qwik";
  ...
  return (
    <Menu.Root>
      ...
      <section class="space-y-3">
        ...
        <CodeExample>
          <Desc>Vnořené menu: <code class="text-caption-1">Menu.Sub</code>, <code class="text-caption-1">SubTrigger</code> a položky se šipkou doprava.</Desc>
          <TabExample>
            <Menu.Root>
          ...
          <TabCode>{`import { LuChevronRight, LuSettings } from "@qwikest/icons/lucide";
import { Menu } from "~/components/ui/menu";
import { MenuItem } from "~/components/ui/menu-item";
