...
<div class="flex flex-wrap items-center gap-2">
  ...
  <Badge size="md">Medium</Badge>
      ...
      <section class="space-y-3">
        ...
        <CodeExample>
          <Desc>Doplňkové třídy (např. <code class="text-caption-1">align-middle</code>, <code class="text-caption-1">ml-2</code>) sloučíš přes <code class="text-caption-1">class</code>.</Desc>
          <TabExample>
