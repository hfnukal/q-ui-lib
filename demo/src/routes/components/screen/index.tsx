    ...
    <div class="space-y-10">
      <div>
        ...
        <p class="mt-2 max-w-prose text-body text-secondary-label">
          Kořen rozvržení: celá obrazovka, bez scrollu na{" "}
          <code class="text-caption-1">body</code> (
          <code class="rounded bg-fill-secondary/20 px-1 py-0.5 text-caption-1">
            LAYOUT.md
          </code>
          ). Uvnitř použijte <code class="text-caption-1">ScrollArea</code> nebo{" "}
          <code class="text-caption-1">min-h-0 flex-1</code>.
        </p>
      </div>
      ...
      <section class="space-y-3">
        ...
        <CodeExample>
          <Desc>
            <code class="text-caption-1">Screen</code> +{" "}
            <code class="text-caption-1">Split</code> +{" "}
            <code class="text-caption-1">Stack</code> +{" "}
            <code class="text-caption-1">ScrollArea</code> +{" "}
                    ...
                    <Stack direction="column" gap={0} class="h-full min-h-0">
                      ...
                      >
                        <Box
                          ...
                          background="grouped"
                          rounded="lg"
                          class="text-body text-secondary-label"
                        >
                          <ul class="space-y-2">
