  ...
  return (
    <div class="space-y-10">
      ...
      <section class="space-y-3">
        ...
        <CodeExample>
          <Desc>
            Minimální karta jen s{" "}
            <code class="text-caption-1">Card.Content</code> a vlastním
            odsazením přes <code class="text-caption-1">class</code>.
          </Desc>
          <TabExample>
            <Card.Root class="max-w-sm">
              <Card.Content class="pt-6">
