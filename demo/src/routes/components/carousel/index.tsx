    ...
    <div class="space-y-10">
      <div>
        ...
        <p class="mt-2 max-w-prose text-callout text-secondary-label">
          ...
          ); styly odpovídají ostatním komponentám v demu (tokeny z COLORS.md). Snímky používají{" "}
          <code class="rounded-md bg-fill-secondary px-1.5 py-0.5 text-caption-1 text-label">Card</code> z{" "}
          <code class="rounded-md bg-fill-secondary px-1.5 py-0.5 text-caption-1 text-label">
            ~/components/ui/card
          </code>
          .
      ...
      <section class="space-y-3">
        ...
        <p class="text-callout text-secondary-label">
          Pod karuselem jsou vystředěné tečky: aktivní snímek je vyplněný, ostatní jen obrysové. Kliknutím na tečku
          přejdeš na daný snímek. Šipky jsou textové (‹ ›), bez ikon. Uvnitř každého snímku je kompletní{" "}
          <code class="text-caption-1 text-label">Card</code> s titulkem, popisem a obsahem; na{" "}
          <code class="text-caption-1 text-label">Carousel.Slide</code> je{" "}
          <code class="text-caption-1 text-label">border-0 bg-transparent p-0</code>, aby se nepletly dva rámečky.
        </p>
              ...
              <Carousel.Scroller>
                <Carousel.Slide class={slideChrome}>
                  <Card.Root class="w-full">
                    <Card.Header>
                      <Card.Title>První karta</Card.Title>
                      <Card.Description>Ukázka Card v karuselu</Card.Description>
                    </Card.Header>
                    <Card.Content>
                      <p class="text-callout text-secondary-label">
                        Obsah prvního snímku — stejné stavební bloky jako na stránce Card.
                      </p>
                    </Card.Content>
                  </Card.Root>
                </Carousel.Slide>
                <Carousel.Slide class={slideChrome}>
                  <Card.Root class="w-full">
                    <Card.Header>
                      ...
                      <Card.Description>Další položka ve stejném formátu</Card.Description>
                    </Card.Header>
                    <Card.Content>
                      <p class="text-callout text-secondary-label">
                ...
                <Carousel.Slide class={slideChrome}>
                  <Card.Root class="w-full">
                    <Card.Header>
                      ...
                      <Card.Description>Poslední snímek v této ukázce</Card.Description>
                    </Card.Header>
                    <Card.Content>
                      <p class="text-callout text-secondary-label">
                        S <code class="text-caption-1 text-label">rewind</code> se z posledního snímku vrátíš na první.
                      </p>
                    </Card.Content>
                  </Card.Root>
                </Carousel.Slide>
      ...
      <section class="space-y-3">
        ...
        <p class="text-callout text-secondary-label">
          ...
          <code class="text-caption-1 text-label">Carousel.Player</code> — u uživatelů s{" "}
          <code class="text-caption-1 text-label">prefers-reduced-motion</code> se tlačítko přehrávače
          skryje (headless CSS). Snímky jsou opět karty s obsahem.
        </p>
        <CodeExample code={codeAutoplay}>
          <Carousel.Root
            class="max-w-xl"
            rewind
            bind:autoplay={autoplay}
            ...
            <Carousel.Scroller>
              <Carousel.Slide class={slideChrome}>
                <Card.Root class="w-full">
                  <Card.Header>
                    ...
                    <Card.Description>Zapni přehrávačem pod karuselem</Card.Description>
                  </Card.Header>
                  <Card.Content>
                    <p class="text-callout text-secondary-label">
                      Interval je 3,5 s; s <code class="text-caption-1 text-label">rewind</code> cyklus pokračuje od
                      začátku.
                    </p>
                  </Card.Content>
                </Card.Root>
              ...
              <Carousel.Slide class={slideChrome}>
                <Card.Root class="w-full">
                  <Card.Header>
                    <Card.Title>Druhá karta</Card.Title>
                    <Card.Description>Další snímek ve slideshow</Card.Description>
                  </Card.Header>
                  <Card.Content>
                    <p class="text-callout text-secondary-label">
                      Stejná struktura <code class="text-caption-1 text-label">Card</code> jako u prvního snímku.
                    </p>
                  </Card.Content>
                </Card.Root>
              </Carousel.Slide>
      ...
      <section class="space-y-3">
        ...
        <p class="text-callout text-secondary-label">
          ...
          <code class="text-caption-1 text-label">Carousel.Step</code> — karty v snímcích, skok přímo podle čísla.
        </p>
        <CodeExample code={codeStepper}>
          <Carousel.Root class="max-w-md" rewind>
            ...
            <Carousel.Scroller>
              <Carousel.Slide class={slideChrome}>
                <Card.Root class="w-full">
                  ...
                  <Card.Content>
                    <p class="text-callout text-secondary-label">Obsah prvního kroku v kartě.</p>
                  </Card.Content>
                </Card.Root>
              </Carousel.Slide>
              <Carousel.Slide class={slideChrome}>
                <Card.Root class="w-full">
                  ...
                  <Card.Content>
                    <p class="text-callout text-secondary-label">Obsah druhého kroku.</p>
                  </Card.Content>
                </Card.Root>
              </Carousel.Slide>
              <Carousel.Slide class={slideChrome}>
                <Card.Root class="w-full">
                  ...
                  <Card.Content>
                    <p class="text-callout text-secondary-label">Obsah třetího kroku.</p>
                  </Card.Content>
                </Card.Root>
              </Carousel.Slide>
            </Carousel.Scroller>
