    ...
    <div class="space-y-10">
      <div>
        ...
        <p class="mt-2 max-w-prose text-body text-secondary-label">
          Spojený rámeček pro pole a prefixy/sufixy (nebo tlačítko) podle vzoru shadcn Input Group —
          jeden společný okraj, stín a <code class="text-caption-1">focus-within</code> kroužek.
          Komponenta je v{" "}
      ...
      <section class="space-y-3">
        ...
        <CodeExample code={codeSuffix}>
          <div class="max-w-md">
            <Label for="demo-ig-mail" class="mb-2 block">
              Firemní e-mail
            </Label>
            <InputGroup.Root aria-label="E-mail">
              <InputGroup.Input id="demo-ig-mail" type="email" autoComplete="email" placeholder="jméno" />
              <InputGroup.Addon align="end">@firma.cz</InputGroup.Addon>
            </InputGroup.Root>
          </div>
        </CodeExample>
      ...
      <section class="space-y-3">
        ...
        <p class="text-callout text-secondary-label">
          Přímé dítě <code class="text-caption-1">Button</code> dostane zarovnání a oddělovací okraj od skupiny.
        </p>
        <CodeExample code={codeButton}>
          <div class="max-w-md">
            <InputGroup.Root aria-label="Hledat">
      ...
      <section class="space-y-3">
        ...
        <CodeExample code={codeIconAddon}>
          <div class="max-w-md">
            <InputGroup.Root aria-label="Hledat">
