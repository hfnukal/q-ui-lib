    ...
    <div class="space-y-10">
      <div>
        ...
        <p class="mt-2 max-w-prose text-body text-secondary-label">
          ...
          , styly podle COLORS.md (jako Dropdown menu). Zavření: Escape, klik
          mimo.
        </p>
      </div>
      ...
      <section class="space-y-3">
        ...
        <CodeExample>
          <Desc>
            ...
            <code class="text-caption-1">Trigger</code> +{" "}
            <code class="text-caption-1">Content</code>. Přímé odkazy použij{" "}
            <code class="text-caption-1">Link</code>.
          </Desc>
          <TabExample>
            <div class="rounded-lg border border-separator-opaque/40 bg-surface-raised p-4">
              <NavigationMenu.Root class="justify-start">
                <NavigationMenu.List>
                  ...
                  <NavigationMenu.Item>
                    <NavigationMenu.Link href="#nav-demo">
                      Ceník
                    </NavigationMenu.Link>
                  </NavigationMenu.Item>
                </NavigationMenu.List>
      ...
      <section class="space-y-3">
        ...
        <CodeExample>
          <Desc>
            Oddělovač mezi položkami vodorovné lišty —{" "}
            <code class="text-caption-1">NavigationMenu.Separator</code>.
          </Desc>
          <TabExample>
            <div class="rounded-lg border border-separator-opaque/40 bg-surface-raised p-4">
              <NavigationMenu.Root class="justify-start">
                <NavigationMenu.List>
                  <NavigationMenu.Item value="dokumentace">
                    <NavigationMenu.Trigger>Dokumentace</NavigationMenu.Trigger>
                    <NavigationMenu.Content>
                      <p class="px-2 py-1 text-caption-1 text-secondary-label">
                        Začínáme
                      </p>
                      <a
                        class="block rounded-md px-3 py-2 text-callout text-label no-underline hover:bg-surface-overlay"
          ...
          <TabCode>{codeWithSeparator}</TabCode>
        </CodeExample>
      </section>
    </div>
  );
