    ...
    <div class="space-y-10">
      <div>
        ...
        <p class="mt-2 max-w-prose text-body text-secondary-label">
          ...
          <code class="text-caption-1">Toggle</code>: <code class="text-caption-1">aria-pressed</code>,{" "}
          <code class="text-caption-1">bind:pressed</code>, <code class="text-caption-1">disabled</code>.
        </p>
      </div>
      ...
      <section class="space-y-3">
        ...
        <CodeExample code={codeBasic}>
          <div class="flex flex-wrap items-center gap-4">
            <Switch bind:pressed={notifications} aria-label="Push notifikace" />
      ...
      <section class="space-y-3">
        ...
        <CodeExample code={codeInitialDisabled} layout="stack">
