    ...
    <div class="space-y-10">
      <div>
        ...
        <p class="mt-2 max-w-prose text-body text-secondary-label">
          ...
          (viz SHADCN.md). Vlastní implementace flex + pointer events, tokeny z COLORS.md (
          <code class="text-caption-1">separator</code>,{" "}
      ...
      <section class="space-y-3">
        ...
        <p class="text-callout text-secondary-label">
          Přetahujte oddělovač nebo použijte šipky vlevo/vpravo, když má fokus. Volitelně{" "}
          <code class="text-caption-1">withHandle</code> pro vizuální úchop.
        </p>
      ...
      <section class="space-y-3">
        ...
        <p class="text-callout text-secondary-label">
          <code class="text-caption-1">direction=&quot;vertical&quot;</code> — kurzor{" "}
          <code class="text-caption-1">row-resize</code>, klávesy nahoru/dolů.
        </p>
      ...
      <section class="space-y-3">
        ...
        <div class="rounded-lg border border-separator-opaque/40 p-2">
          <Resizable.PanelGroup direction="horizontal" class="h-56 rounded-md">
            <Resizable.Panel side="start" minSize={20} class="rounded-l-md bg-surface-raised p-3">
              <span class="text-caption-1 text-label">Sloupec A</span>
            </Resizable.Panel>
            <Resizable.Handle withHandle />
            <Resizable.Panel side="end" minSize={25} class="min-w-0 p-0">
              <Resizable.PanelGroup direction="vertical" class="h-full rounded-r-md border-l border-separator">
                <Resizable.Panel side="start" minSize={15} class="bg-surface-overlay p-3">
                  <span class="text-caption-1 text-label">B — horní</span>
                </Resizable.Panel>
                <Resizable.Handle />
                <Resizable.Panel side="end" minSize={15} class="bg-grouped-surface p-3">
