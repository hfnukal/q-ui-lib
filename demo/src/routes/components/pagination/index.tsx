    ...
    <div class="space-y-10">
      <div>
        ...
        <p class="mt-2 max-w-prose text-body text-secondary-label">
          ...
          <code class="text-caption-1">Pagination</code> — výběr stránky, elipsy
          a šipky; stav stránky drž v signálu nebo URL.
        </p>
      </div>
      ...
      <section class="space-y-3">
        ...
        <CodeExample>
          <Desc>
            <code class="text-caption-1">selectedPage</code>,{" "}
            <code class="text-caption-1">totalPages</code>,{" "}
      ...
      <section class="space-y-3">
        ...
        <CodeExample>
          <Desc>
            Prop <code class="text-caption-1">siblingCount</code> (výchozí 1)
            rozšiřuje okno kolem aktivní stránky.
          </Desc>
          <TabExample>
            <Pagination
      ...
      <section class="space-y-3">
        ...
        <CodeExample>
          <Desc>
            <code class="text-caption-1">customArrowTexts</code> — krátké texty
            místo výchozích PREV / NEXT.
          </Desc>
          <TabExample>
            <Pagination
      ...
      <section class="space-y-3">
        ...
        <CodeExample>
          <Desc>
            Neinteraktivní stránkování přes prop{" "}
