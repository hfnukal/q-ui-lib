  ...
  return (
    <div class="space-y-10">
      ...
      <section class="space-y-3">
        <h2 class="text-headline text-label">Základní tabulka</h2>
        <CodeExample>
          ...
          <TabCode>{`import { Table } from "~/components/ui/table";
...
<Table.Root class="max-w-2xl rounded-lg border border-separator-opaque">
  ...
  <Table.Body>
    ...
    <Table.Row>
      ...
      <section class="space-y-3">
        <h2 class="text-headline text-label">Caption a Footer</h2>
        <CodeExample>
...
<Table.Root class="max-w-2xl rounded-lg border border-separator-opaque">
  ...
  <Table.Footer>
    <Table.Row>
      ...
      <section class="space-y-3">
        <h2 class="text-headline text-label">Stav řádku</h2>
        <CodeExample>
          <Desc>Pro zvýraznění vybraného řádku nastav na <code class="text-caption-1">Table.Row</code> atribut <code class="text-caption-1">data-state="selected"</code>.</Desc>
          <TabExample>
