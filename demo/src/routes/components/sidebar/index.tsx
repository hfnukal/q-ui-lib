    ...
    <div class="space-y-10">
      <div>
        ...
        <p class="mt-2 max-w-prose text-body text-secondary-label">
          ...
          <code class="text-caption-1">Sidebar.Trigger</code> na mobilu
          otevírá/zavírá drawer, na desktopu přepíná ikonový režim.
        </p>
      </div>
      ...
      <section class="space-y-3">
        ...
        <CodeExample>
          <Desc>
            <code class="text-caption-1">Provider</code> →{" "}
            <code class="text-caption-1">Root</code> (panel) +{" "}
            <code class="text-caption-1">Inset</code> (hlavní plocha). Volitelně{" "}
            <code class="text-caption-1">Rail</code> pro rozbalení ze sbaleného
            stavu.
          </Desc>
          <TabExample>
            <Sidebar.Provider class={shellClass}>
              <Sidebar.Root>
                <Sidebar.Rail />
                <Sidebar.Header>
                  <p class="truncate text-headline font-semibold text-label">
                    Aplikace
                  </p>
                </Sidebar.Header>
                <Sidebar.Content>
                ...
                <Sidebar.Footer>
                  <p class="truncate text-caption-1 text-secondary-label">
                    Knihovna q-ui-lib
                  </p>
                </Sidebar.Footer>
              </Sidebar.Root>
              <Sidebar.Inset>
                ...
                <div class="p-4 text-body text-secondary-label">
                  Oblast vedle postranního panelu. Zuž okno pod 768px a použij
                  trigger v záhlaví — panel vyjede zleva přes překryv.
                </div>
              </Sidebar.Inset>
            </Sidebar.Provider>
          </TabExample>
      ...
      <section class="space-y-3">
        ...
        <div class={shellClass}>
          <CodeExample>
            <Desc>
              Prop <code class="text-caption-1">defaultCollapsed</code> na{" "}
              <code class="text-caption-1">Provider</code> — užitečné pro úzké
              panely s ikonami; popisky v{" "}
              <code class="text-caption-1">GroupLabel</code> jsou na desktopu ve
              sbaleném režimu skryté (
              <code class="text-caption-1">sr-only</code>).
            </Desc>
            <TabExample>
              <Sidebar.Provider class="h-full min-h-[20rem]" defaultCollapsed>
                <Sidebar.Root>
                  <Sidebar.Rail />
                  <Sidebar.Header>
                    <p class="truncate text-center text-caption-1 font-semibold text-label md:px-0">
                      App
                    </p>
                  </Sidebar.Header>
                  <Sidebar.Content>
                ...
                <Sidebar.Inset>
                  <div class="flex items-center gap-2 border-b border-separator-opaque p-3">
                    ...
                    <span class="text-callout text-label">
                      Rozbalit panel — trigger nebo rail
                    </span>
                  </div>
                  <p class="p-4 text-body text-secondary-label">
                    Panel začíná v režimu jen ikon (šířka ~3,5rem na md+).
                  </p>
                </Sidebar.Inset>
              </Sidebar.Provider>
            </TabExample>
